...
const Product = class Product {
    constructor(message){
        const [name, priceString, availability] = message.split(",");
        this.name = name;
    ...
    static printProducts = (products) => {
        products.forEach(product => {
            ...
            console.log(`Product: ${product.name}, Cost: ${newPrice}, Availability: ${available}`);
     });
...
// console.log(product1.message.split(','));
